$(document).ready(function () {
    $("#googleform").submit(function (event) {
        ...
        //メールを取得
        data.append('entry.307426390', $("#googleform input[name=email]").val());
        //名前を取得
        data.append('entry.718895314', $("#googleform input[name=name]").val());
        //歳を取得
        data.append('entry.1891173114', $("#googleform input[name=age]:checked").val());
        //お問い合わせ内容を取得
